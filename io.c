...
> Created Time: 2013��?8��?0��?星期��?17��?0��?2��?
************************************************************************/
#include <stdio.h>
#include <stdarg.h>
#include <stdint.h>
...
*>����:
*>����:���ùܽ�ģʽ
*>��ע: ģʽ: INPUT��OUTPUT��PWM_OUTPUT��PULLUP��PULLDOWN��PULLOFF��CHECK
********************************************************************************/
...
*>����:
*>����:  
*>��ע: Attempt to set a high priority schedulling for the running program
********************************************************************************/
